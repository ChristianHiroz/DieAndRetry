...
',
  ...
  'ComurImageBundle' => 
  array (
    'A PHP extension stopped the file upload' => 'Une extension PHP a arrêté le chargement du fichier',
    'Add image' => 'Ajouter une image',
    'Crop & Use !' => 'Cropper & Utiliser !',
    'Crop and Use' => 'Cropper et Utiliser',
    'Drop your file here' => 'Glissez votre fichier ici',
    'Edit' => 'Modifier',
    'Failed to resize image' => 'Erreur dans le changement de  de l\'image',
    'Failed to write file to disk' => 'Echec d\'écriture du fichier sur le disque',
    'File is too big' => 'Le fichier est trop gros',
    'File is too small' => 'Le fichier est trop petit',
    'File upload aborted' => 'Chargement interrompu',
    'Filetype not allowed' => 'Type de fichier non autorisé',
    'Image exceeds maximum height' => 'L\'image dépasse la hauteur maximum',
    'Image exceeds maximum width' => 'L\'image dépasse la largeur maximum',
    'Image requires a minimum height (%min%)' => 'L\'image doit avoir une hauteur minimum (%min%)',
    'Image requires a minimum width (%min%)' => 'L\'image doit avoir une largeur minimum (%min%)',
    'Insert Image' => 'Uploader image',
    'Maximum number of files exceeded' => 'Nombre de fichiers maximum atteint',
    'Missing a temporary folder' => 'Dossier temporaire manquant',
    'No file was uploaded' => 'Aucun fichier chargé',
    'Please adjust selection to your image' => 'Veuillez ajuster la selection à votre image',
    'Please select or upload an image' => 'Veuillez uploader ou sélectionner une image existante',
    'Select Existing' => 'Sélectionner une image existante',
    'Select a file...' => 'Sélectionnez un fichier...',
    'The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form' => 'La taille du fichier dépasse le paramètre MAX_FILE_SIZE spécifié dans le formulaire.',
    'The uploaded file exceeds the post_max_size directive in php.ini' => 'La taille du fichier dépasse le paramètre post_max_filesize du fichier php.ini',
    'The uploaded file exceeds the upload_max_filesize directive in php.ini' => 'La taille du fichier dépasse le paramètre upload_max_filesize du fichier php.ini',
    'The uploaded file was only partially uploaded' => 'Le fichier a été partiellement chargé.',
    'Upload Image' => 'Uploader image',
    'or' => 'ou',
    'Close' => 'Fermer',
  ),
  'SonataCoreBundle' => 
