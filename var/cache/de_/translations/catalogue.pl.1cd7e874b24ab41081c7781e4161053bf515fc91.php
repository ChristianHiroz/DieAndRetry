...
',
  ...
  array (
    ...
    'Crop & Use !' => 'Wytnij i Użyj !',
    'Crop and Use' => 'Wytnij i Użyj',
    'Drop your file here' => 'Upuść tutaj pliki, aby je przesłać',
    'Edit' => 'Edytuj',
    'Failed to resize image' => 'Nie udało się zmienić rozmiaru obrazu',
    'Failed to write file to disk' => 'Nie udało się zapisać pliku na dysku',
    'File is too big' => 'Plik jest za duży',
    'File is too small' => 'Plik jest za mały',
    'File upload aborted' => 'Upload plików przerwany',
    'Filetype not allowed' => 'Typ pliku nie jest dozwolony',
    'Image exceeds maximum height' => 'Wysokość obrazu przekroczyła maksimum',
    'Image exceeds maximum width' => 'Szerokość obrazu przekroczyła maksimum',
    'Image requires a minimum height (%min%)' => 'Obraz wymaga minimalnej wysokości (%min%)',
    'Image requires a minimum width (%min%)' => 'Obraz wymaga minimalnej szerokości (%min%)',
    'Insert Image' => 'Wstaw obrazek',
    'Maximum number of files exceeded' => 'Przekroczono maksymalną liczbę plików',
    'Missing a temporary folder' => 'Brakuje folderu tymczasowego',
    'No file was uploaded' => 'Żaden plik nie został przesłany',
    'Please adjust selection to your image' => 'Proszę dostosować rozmiar zaznaczenia do obrazu',
    'Please select or upload an image' => 'Proszę wybrać lub przesłać obraz',
    'Select Existing' => 'Wybierz istniejące',
    'Select a file...' => 'Wybierz plik...',
    'The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form' => 'Przesłany plik przekracza rozmiar MAX_FILE_SIZE, który został określony w formularzu HTML',
    'The uploaded file exceeds the post_max_size directive in php.ini' => 'Przesłany plik przekracza rozmiar post_max_size, który został określony w php.ini',
    'The uploaded file exceeds the upload_max_filesize directive in php.ini' => 'Przesłany plik przekracza rozmiar upload_max_filesize który został określony w php.ini',
    'The uploaded file was only partially uploaded' => 'Przesłany plik został przesłany tylko częściowo',
