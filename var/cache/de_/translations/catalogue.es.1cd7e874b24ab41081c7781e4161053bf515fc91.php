...
',
  ...
  'ComurImageBundle' => 
  array (
    'A PHP extension stopped the file upload' => 'Una extensión de PHP ha detenido la carga del archivo',
    'Add image' => 'Agregar imagen',
    'Crop & Use !' => '¡Cortar y Usar!',
    'Crop and Use' => 'Cortar y Usar',
    'Drop your file here' => 'Arrastra tu archivo aqui',
    'Edit' => 'Editar',
    'Failed to resize image' => 'No se pudo redimensionar la imagen',
    'Failed to write file to disk' => 'No se pudo escribir el archivo en el disco',
    'File is too big' => 'El archivo es muy pesado',
    'File is too small' => 'El archivo es muy liviano',
    'File upload aborted' => 'Se ha cancelado la carga de archivo',
    'Filetype not allowed' => 'Tipo de archivo no admitido',
    'Image exceeds maximum height' => 'La imagen excede el alto máximo',
    'Image exceeds maximum width' => 'La imagen excede el ancho máximo',
    'Image requires a minimum height (%min%)' => 'La imagen requiere un alto minimo de (%min%)',
    'Image requires a minimum width (%min%)' => 'La imagen requiere un ancho minimo (%min%)',
    'Insert Image' => 'Insertar Imagen',
    'Maximum number of files exceeded' => 'Se ha alcanzado el máximo permitido de archivos',
    'Missing a temporary folder' => 'No se encuentra la carpeta temporal',
    'No file was uploaded' => 'No se ha subido ningun archivo',
    'Please adjust selection to your image' => 'Por favor ajusta la selección a tu imagen',
    'Please select or upload an image' => 'Por favor, selecciona o sube una imagen',
    'Select Existing' => 'Seleccionar existente',
    'Select a file...' => 'Seleccionar un archivo...',
    'The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form' => 'El archivo subido excede la directiva MAX_FILE_SIZE, que fue definida en el formulario HTML',
    ...
    'The uploaded file exceeds the upload_max_filesize directive in php.ini' => 'El archivo excede la directiva upload_max_filesize en php.ini',
    'The uploaded file was only partially uploaded' => 'El archivo se subió parcialmente',
