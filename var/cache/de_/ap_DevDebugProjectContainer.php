...
class ap_DevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'admin.party' => 'getAdmin_PartyService',
    ...
    /**
     * Gets the 'admin.party' service.
     *
     * @return \GuildBundle\Admin\PartyAdmin A GuildBundle\Admin\PartyAdmin instance.
     */
    protected function getAdmin_PartyService()
    {
        $instance = new \GuildBundle\Admin\PartyAdmin('admin.party', 'GuildBundle\\Entity\\Party', 'SonataAdminBundle:CRUD');
     ...
     *
     * @return \GuildBundle\Admin\UserAdmin A GuildBundle\Admin\UserAdmin instance.
     */
    protected function getAdmin_UserService()
    {
        $instance = new \GuildBundle\Admin\UserAdmin('admin.user', 'UserBundle\\Entity\\User', 'SonataAdminBundle:CRUD');
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'JMSTranslationBundle', ($this->targetDirs[3].'\\app/Resources/JMSTranslationBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'JMSTranslationBundle', ($this->targetDirs[3].'\\vendor\\jms\\translation-bundle\\JMS\\TranslationBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ComurImageBundle', ($this->targetDirs[3].'\\app/Resources/ComurImageBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ComurImageBundle', ($this->targetDirs[3].'\\vendor\\comur\\image-bundle\\Comur\\ImageBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'GuildBundle', ($this->targetDirs[3].'\\app/Resources/GuildBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'GuildBundle', ($this->targetDirs[3].'\\src\\GuildBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('PWKP8IVDEk', '', (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dj6z+gw0E8', '', 'e3vEYiDXPmxCXInldwTSOw', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rA-f8OrLA1', '', 'e3vEYiDXPmxCXInldwTSOw', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GoE+MuFCh6', '', 'e3vEYiDXPmxCXInldwTSOw', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\GuildBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'UserBundle\\Entity');
        $c->addDriver($b, 'GuildBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('UserBundle' => 'UserBundle\\Entity', 'GuildBundle' => 'GuildBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0fc5638ebb4155d70a983132669d6f8c5b3cc6e2b3cdc6af1d90db8f7c43483c');
    ...
    {
        return $this->services['fos_user.change_password.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_change_password_form', 'FOS\\UserBundle\\Form\\Type\\ChangePasswordFormType', array(0 => 'ChangePassword', 1 => 'Blog'));
    }
    ...
    {
        return $this->services['fos_user.profile.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_profile_form', 'FOS\\UserBundle\\Form\\Type\\ProfileFormType', array(0 => 'Profile', 1 => 'Blog'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'FOS\\UserBundle\\Form\\Type\\RegistrationFormType', array(0 => 'Registration', 1 => 'Blog'));
    }
    ...
    {
        return $this->services['fos_user.resetting.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_resetting_form', 'FOS\\UserBundle\\Form\\Type\\ResettingFormType', array(0 => 'ResetPassword', 1 => 'Blog'));
    }
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'admin.party', 1 => 'admin.user'));
        $instance->setAdminGroups(array('DieAndRetry' => array('label' => 'DieAndRetry', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'on_top' => false, 'items' => array(0 => array('admin' => 'admin.party', 'label' => 'Groupes', 'route' => '', 'route_params' => array(), 'route_absolute' => true), 1 => array('admin' => 'admin.user', 'label' => 'Utilisateurs', 'route' => '', 'route_params' => array(), 'route_absolute' => true)))));
        $instance->setAdminClasses(array('GuildBundle\\Entity\\Party' => array(0 => 'admin.party'), 'UserBundle\\Entity\\User' => array(0 => 'admin.user')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'admin.party', 1 => 'admin.user'), $this);
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'ComurImageBundle:Form:fields.html.twig', 1 => 'form_div_layout.html.twig', 2 => 'ComurImageBundle:Form:croppable_image_modal.html.twig')), $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Twig_Extension_Debug());
        $instance->addExtension(new \Doctrine\Bundle\DoctrineBundle\Twig\DoctrineExtension());
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'DoctrineBundle', 6 => 'SensioFrameworkExtraBundle', 7 => 'FOSUserBundle', 8 => 'AsseticBundle', 9 => 'FOSJsRoutingBundle', 10 => 'JMSTranslationBundle', 11 => 'ComurImageBundle', 12 => 'UserBundle', 13 => 'BlogBundle', 14 => 'GuildBundle', 15 => 'SonataCoreBundle', 16 => 'SonataBlockBundle', 17 => 'KnpMenuBundle', 18 => 'SonataDoctrineORMAdminBundle', 19 => 'SonataAdminBundle', 20 => 'DebugBundle', 21 => 'WebProfilerBundle', 22 => 'SensioDistributionBundle', 23 => 'SensioGeneratorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\GuildBundle/Resources/views'), 'Guild');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('dfa38151a1e6cfe4c73a6551f71947c6c19f339d');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'GuildBundle' => 'GuildBundle\\GuildBundle',
            ...
            'secret' => 'dfa38151a1e6cfe4c73a6551f71947c6c19f339d',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'dfa38151a1e6cfe4c73a6551f71947c6c19f339d',
            ...
            'assetic.bundles' => array(
                ...
                10 => 'JMSTranslationBundle',
                11 => 'ComurImageBundle',
                12 => 'UserBundle',
                13 => 'BlogBundle',
                14 => 'GuildBundle',
                15 => 'SonataCoreBundle',
                16 => 'SonataBlockBundle',
                17 => 'KnpMenuBundle',
            ...
            'sonata.core.form.types' => array(
                ...
                8 => 'comur_image_bundle.image_type',
                9 => 'comur_image_bundle.gallery_type',
